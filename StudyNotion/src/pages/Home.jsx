    ...
    <div>
      ...
      <div className="relative mx-auto max-w-maxContent flex flex-col w-11/12 items-center text-white justify-between">
        <Link to={"/signup"}>
          ...
          font-bold text-richblack-200 transition-allduration-200 hover:scale-95 w-fit"
          >
            <div
        ...
        <div className="text-center text-4xl font-semibold mt-7">
          ...
          <HighlightText text={"Codding Skills"} />
        </div>
        ...
        <div>
          <CodeBlocks
            ...
            subheading={`Our courses are designed and taught 
            by industry experts who have years of experience in coding and are 
